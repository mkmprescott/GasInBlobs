...
FUNCTION ratioanderror, signal1, noise1, signal2, noise2 ;, signalratio=signalratio, ratioerror=ratioerror
...
;ratioanderrr, civMID(keep).signal, civMID(keep).noise, lyaMID(keep).signal, lyaMID(keep).noise, signalratio=civlyaMID, ratioerror=civlyaerrMID
